...
export async function updateSession(request: NextRequest) {
  ...
  // mistake can make it very hard to debug issues with users being logged out.
  ...
  // if you don't return supabaseResponse, you're potentially setting a cookie that is 
  // already expired, or deleting a cookie before it's actually expired.
